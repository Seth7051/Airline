Public Class frmPastFlightsPilot
    Private Sub frmPastFlightsPilot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Populate_Details(ByRef cmdSelect, ByRef drSourceTable)
        ...
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspPastFlightsPilot", m_conAdministrator)
