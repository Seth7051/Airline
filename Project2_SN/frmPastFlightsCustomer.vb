Public Class frmPastFlightsCustomer
    ...
    Private Sub Populate_Details(ByRef cmdSelect, ByRef drSourceTable)
        ...
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspPastFlightsCustomer", m_conAdministrator)
            cmdSelect.commandtype = CommandType.StoredProcedure

            objParam = cmdSelect.Parameters.Add("@customerID", OleDb.OleDbType.Integer)
