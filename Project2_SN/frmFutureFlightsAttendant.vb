Public Class frmFutureFlightsAttendant
    Private Sub frmFutureFlightsAttendant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Populate_Details(ByRef cmdSelect, ByRef drSourceTable)
        ...
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspFutureFlightsAttendant", m_conAdministrator)
            ...
            drSourceTable.Read()
            lstFlights.Items.Add("Atendant: " & drSourceTable("strName").ToString)
